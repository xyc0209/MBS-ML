...
param_grid_random_forest = {
    'n_estimators': [100, 200, 300],  # 随机森林中树的数量
    'max_depth': [None, 5, 10],  # 每棵树的最大深度
...
# 创建 GridSearchCV 对象
rf_grid_search = GridSearchCV(base_classifier, param_grid_random_forest, scoring=scoring, cv=5, refit='accuracy')
...
best_base_classifier = RandomForestClassifier(**rf_grid_search.best_params_)
# 创建 AdaBoost 分类器
