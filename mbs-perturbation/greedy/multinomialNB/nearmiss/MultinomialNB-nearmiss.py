...
from sklearn.metrics import make_scorer, recall_score, accuracy_score, f1_score, roc_auc_score, precision_score
...
# 读取CSV文件
data = pd.read_csv('D:/dataSet/mbs-interference/greedy.csv')
...
# 将结果保存到Excel文件
results_df.to_excel('greedy-multinomialNB-nearmiss-results.xlsx', index=False)