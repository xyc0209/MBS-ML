...
# 读取CSV文件
data = pd.read_csv('D:/dataSet/mbs/bottleneck.csv')
...
joblib.dump(model, 'bottleneck_randomForest_nearmiss.pkl')
...
# 将结果保存到Excel文件
results_df.to_excel('bottleneck-randomForest-nearmiss-results.xlsx', index=False)