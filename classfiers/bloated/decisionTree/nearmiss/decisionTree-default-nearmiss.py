...
# 原始数据类别数量
print("原始数据类别数量:")
print(data['bloated'].value_counts())
...
joblib.dump(best_model, 'nano_decisionTree_nearmiss.pkl')
...
# 将结果保存到Excel文件
results_df.to_excel('bloated-decisionTree-nearmiss-results.xlsx', index=False)